...
void ATurtlebotBurger::Init()
{
    if (!IsInitialized)
    {
        ...
        {
            static ConstructorHelpers::FObjectFinder<UMaterial> RobotMaterial(
                TEXT("Material'/Game/Blueprints/M_RobotMat.M_RobotMat'"));
            VehicleMaterial = RobotMaterial.Object;
            static ConstructorHelpers::FObjectFinder<UMaterial> CasterBallMaterial(
                TEXT("Material'/Game/Blueprints/M_CasterBallMat.M_CasterBallMat'"));
